...
A standalone browser app for a five-day reusable lifting plan: four primary training days plus a lighter core/full-body day.
...
`https://jordantlschumann5.github.io/lift/`

Progress is saved in the browser with `localStorage`. Use Export/Import to move progress between devices.
